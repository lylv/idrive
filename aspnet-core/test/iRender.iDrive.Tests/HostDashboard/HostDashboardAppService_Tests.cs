...
using iRender.iDrive.MultiTenancy.HostDashboard;
...
namespace iRender.iDrive.Tests.HostDashboard
{
    ...
    public class HostDashboardAppService_Tests : AppTestBase
    {
        ...
        private void CreatePaidPayment(iDriveDbContext context, SubscriptionPayment subscriptionPayment)
        {
