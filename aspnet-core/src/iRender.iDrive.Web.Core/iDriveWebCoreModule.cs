...
using iRender.iDrive.Web.Authentication.JwtBearer;
using iRender.iDrive.Web.Authentication.TwoFactor;
using iRender.iDrive.Web.Chat.SignalR;
using iRender.iDrive.Web.Configuration;

namespace iRender.iDrive.Web
{
    [DependsOn(
        typeof(iDriveApplicationModule),
        typeof(iDriveEntityFrameworkCoreModule),
    ...
    public class iDriveWebCoreModule : AbpModule
    {
        private readonly IHostingEnvironment _env;
        private readonly IConfigurationRoot _appConfiguration;

        public iDriveWebCoreModule(IHostingEnvironment env)
        {
            _env = env;
        ...
        public override void PreInitialize()
        {
            ...
            Configuration.Modules.AbpAspNetCore()
                .CreateControllersForAppServices(
                    typeof(iDriveApplicationModule).GetAssembly()
                );
        ...
        {
            IocManager.RegisterAssemblyByConvention(typeof(iDriveWebCoreModule).GetAssembly());
        }
        ...
        private void SetAppFolders()
        {
            ...
            {
                var currentAssemblyDirectoryPath = typeof(iDriveWebCoreModule).GetAssembly().GetDirectoryPathOrNull();
