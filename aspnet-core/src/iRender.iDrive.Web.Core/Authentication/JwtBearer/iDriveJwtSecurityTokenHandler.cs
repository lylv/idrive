...
namespace iRender.iDrive.Web.Authentication.JwtBearer
{
    public class iDriveJwtSecurityTokenHandler : ISecurityTokenValidator
    {
        private readonly JwtSecurityTokenHandler _tokenHandler;

        public iDriveJwtSecurityTokenHandler()
        {
