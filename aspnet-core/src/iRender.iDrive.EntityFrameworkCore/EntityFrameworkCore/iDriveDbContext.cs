...
{
    public class iDriveDbContext : AbpZeroDbContext<Tenant, Role, User, iDriveDbContext>, IAbpPersistedGrantDbContext
    {
        ...
        public iDriveDbContext(DbContextOptions<iDriveDbContext> options)
            : base(options)
        {
