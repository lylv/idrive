...
using iRender.iDrive.Auditing.Exporting;
...
using EntityHistoryHelper = iRender.iDrive.EntityHistory.EntityHistoryHelper;

namespace iRender.iDrive.Auditing
{
    [DisableAuditing]
    [AbpAuthorize(AppPermissions.Pages_Administration_AuditLogs)]
    public class AuditLogAppService : iDriveAppServiceBase, IAuditLogAppService
    {
