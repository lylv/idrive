...
{
    public class SessionAppService : iDriveAppServiceBase, ISessionAppService
    {
        ...
        public async Task<GetCurrentLoginInformationsOutput> GetCurrentLoginInformations()
        {
            var output = new GetCurrentLoginInformationsOutput
            {
                Application = new ApplicationInfoDto
                {
                    ...
                    Currency = iDriveConsts.Currency,
                    CurrencySign = iDriveConsts.CurrencySign,
                    AllowTenantsToChangeEmailSettings = iDriveConsts.AllowTenantsToChangeEmailSettings
                }
            };
