...
namespace iRender.iDrive.Install
{
    [AbpAllowAnonymous]
    [DisableAuditing]
    public class InstallAppService : iDriveAppServiceBase, IInstallAppService
    {
        private readonly AbpZeroDbMigrator<iDriveDbContext> _migrator;
        ...
        private string GetConnectionString()
        {
            ...
            return connectionStrings.Property(iDriveConsts.ConnectionStringName).Value.ToString();
        }
