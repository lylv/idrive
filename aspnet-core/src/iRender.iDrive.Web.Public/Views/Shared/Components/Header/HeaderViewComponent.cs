...
using iRender.iDrive.Web.Public.Startup;
using iRender.iDrive.Web.Session;

namespace iRender.iDrive.Web.Public.Views.Shared.Components.Header
{
    public class HeaderViewComponent : iDriveViewComponent
    {
