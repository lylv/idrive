...
using iRender.iDrive.Core.Base;
using iRender.iDrive.Core.Extensions;
using iRender.iDrive.Dto;
using iRender.iDrive.Types;

namespace iRender.iDrive.Queries
{
    public class OrganizationUnitQuery : iDriveQueryBase<ListGraphType<OrganizationUnitType>, List<OrganizationUnitDto>>
    {
