...
namespace iRender.iDrive.Authentication.TwoFactor.Google
{
    public class GoogleAuthenticatorProvider : iDriveServiceBase, IUserTwoFactorTokenProvider<User>, ITransientDependency
    {
        ...
        public Task<string> GenerateAsync(string purpose, UserManager<User> userManager, User user)
        {
            ...
            var setupInfo = _googleTwoFactorAuthenticateService.GenerateSetupCode("iRender.iDrive", user.EmailAddress, user.GoogleAuthenticatorKey, 300, 300);
