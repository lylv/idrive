...
namespace iRender.iDrive.MultiTenancy.Payments.Stripe
{
    ...
    public class StripeGatewayManager : iDriveServiceBase,
        ...
        ITransientDependency
    {
        ...
        public static string ProductName = "iDrive";
        ...
        {
            return editionName + "_" + paymentPeriodType + "_" + iDriveConsts.Currency;
        }
