...
using iRender.iDrive.MultiTenancy.Demo;
...
namespace iRender.iDrive.MultiTenancy
{
    ...
    public class TenantManager : AbpTenantManager<Tenant, User>
    {
        ...
        public async Task CheckEditionAsync(int? editionId, bool isInTrialPeriod)
        {
            ...
            var error = LocalizationManager.GetSource(iDriveConsts.LocalizationSourceName).GetString("FreeEditionsCannotHaveTrialVersions");
