...
using iRender.iDrive.Features;
using iRender.iDrive.Friendships;
using iRender.iDrive.Friendships.Cache;
using iRender.iDrive.Localization;
using iRender.iDrive.MultiTenancy;
using iRender.iDrive.Net.Emailing;
...
namespace iRender.iDrive
{
    ...
    public class iDriveCoreModule : AbpModule
    {
        public override void PreInitialize()
        {
            ...
            iDriveLocalizationConfigurer.Configure(Configuration.Localization);
            ...
            Configuration.MultiTenancy.IsEnabled = iDriveConsts.MultiTenancyEnabled;
            ...
            Configuration.ReplaceService<IMailKitSmtpBuilder, iDriveMailKitSmtpBuilder>(DependencyLifeStyle.Transient);
            ...
            Configuration.ReplaceService(typeof(IEmailSenderConfiguration), () =>
            {
                Configuration.IocManager.IocContainer.Register(
                    Component.For<IEmailSenderConfiguration, ISmtpEmailSenderConfiguration>()
                             .ImplementedBy<iDriveSmtpEmailSenderConfiguration>()
                             .LifestyleTransient()
                );
            });
        ...
        {
            IocManager.RegisterAssemblyByConvention(typeof(iDriveCoreModule).GetAssembly());
        }
