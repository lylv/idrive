...
using MvvmHelpers;
using iRender.iDrive.Authorization.Users.Profile;
using iRender.iDrive.Authorization.Users.Profile.Dto;
using iRender.iDrive.Commands;
using iRender.iDrive.Core.Threading;
using iRender.iDrive.Models.NavigationMenu;
using iRender.iDrive.Services.Navigation;
...
using iRender.iDrive.ApiClient;
using iRender.iDrive.Controls;
using iRender.iDrive.Dto;
using iRender.iDrive.Extensions;
using iRender.iDrive.Localization;
using iRender.iDrive.UI;
using iRender.iDrive.UI.Assets;
using iRender.iDrive.Views;
using DependencyResolver = iRender.iDrive.Core.Dependency.DependencyResolver;
...
namespace iRender.iDrive.ViewModels
{
    public class MainViewModel : XamarinViewModel
    {
        ...
        private const string ApplicationName = "iDrive";
